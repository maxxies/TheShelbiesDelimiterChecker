...
function increaseFont() {
    if (font < 2.2) {  //sets limit
        ...
        text.style.cssText = 'font-size: ' + fixedFont.toString() + 'em; font-family : ' + fontstyle + ';'; //changes font size property
...
function decreaseFont() {
    if (font > 0.8) { //sets limit
        ...
        text.style.cssText = 'font-size: ' + fixedFont.toString() + 'em; font-family : ' + fontstyle + ';';//changes the font property
